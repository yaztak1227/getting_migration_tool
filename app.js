(() => {
  ...
  const TRANSLATIONS = {
    ja: {
      ...
      headerInfoText:
        "検索パワーごとの移民対象王国一覧を取得し、そのまま検索・絞り込み・ページ表示まで行えます。ローカルの Node.js プロキシ経由で API を取得します。",
    ...
    en: {
      ...
      headerInfoText:
        "Fetch migration target kingdoms by search power, then search, filter, and paginate in one screen. API data is retrieved through the local Node.js proxy.",
      languageLabel: "Language",
